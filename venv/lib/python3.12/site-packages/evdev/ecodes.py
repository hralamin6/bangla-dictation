...
BTN_GRIPL: Final[int] = 548
BTN_GRIPL2: Final[int] = 550
BTN_GRIPR: Final[int] = 549
BTN_GRIPR2: Final[int] = 551
...
FF_EFFECT_MIN: Final[int] = 79
FF_FRICTION: Final[int] = 84
FF_GAIN: Final[int] = 96
FF_HAPTIC: Final[int] = 79
...
INPUT_PROP_PRESSUREPAD: Final[int] = 7
...
KEY_ACTION_ON_SELECTION: Final[int] = 596
...
KEY_CONTEXTUAL_INSERT: Final[int] = 597
KEY_CONTEXTUAL_QUERY: Final[int] = 598
...
KEY_EPRIVACY_SCREEN_OFF: Final[int] = 595
KEY_EPRIVACY_SCREEN_ON: Final[int] = 594
...
SND_CNT: Final[int] = 8
SND_MAX: Final[int] = 7
SND_PROFILE_RING: Final[int] = 2
SND_PROFILE_SILENT: Final[int] = 0
SND_PROFILE_VIBRATE: Final[int] = 1
...
ecodes: Dict[str, int] = { 'ABS_BRAKE': 10,
  ...
  'SND_MAX': 7,
  'SND_PROFILE_RING': 2,
  'SND_PROFILE_SILENT': 0,
  'SND_PROFILE_VIBRATE': 1,
  'SND_TONE': 2,
...
bytype: Dict[int, Dict[int, Union[str, Tuple[str]]]] = { 0: {0: 'SYN_REPORT', 1: 'SYN_CONFIG', 2: 'SYN_MT_REPORT', 3: 'SYN_DROPPED', 15: 'SYN_MAX', 16: 'SYN_CNT'},
  ...
  17: { 0: 'LED_NUML',
        ...
        15: 'LED_MAX',
        16: 'LED_CNT'},
  18: { 0: ('SND_CLICK', 'SND_PROFILE_SILENT'),
        1: ('SND_BELL', 'SND_PROFILE_VIBRATE'),
        2: ('SND_PROFILE_RING', 'SND_TONE'),
        7: 'SND_MAX',
        8: 'SND_CNT'},
  20: {0: 'REP_DELAY', 1: ('REP_MAX', 'REP_PERIOD'), 2: 'REP_CNT'},
  21: { 79: ('FF_EFFECT_MIN', 'FF_HAPTIC'),
        80: 'FF_RUMBLE',
        81: 'FF_PERIODIC',
        82: 'FF_CONSTANT',
        83: 'FF_SPRING',
...
SND: Dict[int, Union[str, Tuple[str]]] = { 0: ('SND_CLICK', 'SND_PROFILE_SILENT'),
  1: ('SND_BELL', 'SND_PROFILE_VIBRATE'),
  2: ('SND_PROFILE_RING', 'SND_TONE'),
  7: 'SND_MAX',
  8: 'SND_CNT'}
...
FF: Dict[int, Union[str, Tuple[str]]] = { 79: ('FF_EFFECT_MIN', 'FF_HAPTIC'),
  80: 'FF_RUMBLE',
  81: 'FF_PERIODIC',
  82: 'FF_CONSTANT',
  83: 'FF_SPRING',
